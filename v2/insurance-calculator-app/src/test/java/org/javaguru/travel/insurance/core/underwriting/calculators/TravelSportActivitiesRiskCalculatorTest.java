...
class TravelSportActivitiesRiskCalculatorTest {
    ...
    @InjectMocks
    private TravelSportActivitiesRiskCalculator calculator;

    @Test
    @DisplayName("Test: Can get sportActivities singleRiskPremium")
